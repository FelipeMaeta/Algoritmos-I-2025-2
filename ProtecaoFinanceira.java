...
public class ProtecaoFinanceira {

    public static void main(String[] args) {
        Scanner entrada = new Scanner(System.in);

        System.out.println("Olá! Bem-vindo(a) ao guia de proteção contra golpes financeiros.");
        System.out.print("Por favor, digite seu nome para continuarmos: ");
        String nomeUsuario = entrada.nextLine();

        System.out.println("\nOlá, " + nomeUsuario + "! É muito importante se proteger de golpes. Aqui estão 18 maneiras de se defender:");

        int opcao = 1;
        String continuar;

        do {
            System.out.println("\n--- Dica de Segurança #" + opcao + " ---");
            switch (opcao) {
                case 1:
                    System.out.println("Atuação do Banco Central na prevenção de golpes e fraudes: O Conselho Monetário Nacional (CMN) e o Banco Central (BC), em geral, não disciplinam procedimentos específicos de segurança relativos a golpes e fraudes, inclusive alertas emitidos pelas instituições autorizadas, levando em consideração as peculiaridades delas.\n" +
                            "\n" +
                ...
                case 2:
                    ...
                    break;
                case 3:
                    System.out.println("Vítima fez um Pix e caiu em um golpe: ​Caso tenha sido vítima de um golpe, o primeiro passo é entrar em contato com seu banco para relatar o caso e solicitar a devolução dos valores transferidos para o suposto golpista. Em paralelo, é recomendável registrar um Boletim de Ocorrência na autoridade policial.\n" +
                            "\n" +
                            "Com base no relato:\n" +
                            "\n" +
                ...
                case 4:
                    ...
                    break;
                case 5:
                    System.out.println("Vítima fez uma TED e caiu em um golpe: ​Caso tenha sido vítima de um golpe, o primeiro passo é a vítima imediatamente entrar em contato com seu banco para relatar o caso e solicitar a devolução dos valores transferidos para o suposto golpista.\n" +
                            "\n" +
                    ...
                    break;
                case 6:
                    System.out.println("Vítima fez compra com cartão e caiu em golpe: ​O primeiro passo é a vítima imediatamente entrar em contato com seu banco para relatar o caso e contestar a compra realizada com cartão. Em paralelo, é recomendável registrar um Boletim de Ocorrência.\n" +
                            "\n" +
                            "Se a situação não for resolvida, a vítima pode:\n" +
                            "\n" +
                            "Procurar o Procon de seu estado ou o Poder Judiciário; ou\n" +
                    ...
                    break;
                case 7:
                    System.out.println("Vítima pagou um boleto e caiu em um golpe: ​Atualmente, todos os boletos emitidos por bancos são registrados conforme convenção. Isso significa que os dados dos beneficiários dos boletos sempre aparecem quando a pessoa vai pagar o boleto e que os boletos podem ser pagos em qualquer banco.\n" +
                            "\n" +
                    ...
                    break;
                case 8:
                    System.out.println("Banco do golpista detecta que não há dinheiro na conta dele: ​Após relatar o golpe sofrido, o banco da vítima instaura o Mecanismo Especial de Devolução (MED) do Pix. Comprovada a fraude, o banco do suposto golpista devolve os recursos para a vítima em até 96 horas, a contar do término da avaliação.\n" +
                            "\n" +
                ...
                case 9:
                    ...
                    break;
                case 10:
                    System.out.println("Vítima não reconhece uma compra em maquininha de cartão: Caso não reconheça determinada compra feita em maquininha de cartão, recomenda-se conversar com o lojista ou entrar em contato com o banco.\n" +
                            "\n" +
                            "Se a situação não for resolvida, a vítima pode:\n" +
                            "\n" +
                            "Procurar o Procon de seu estado ou o Poder Judiciário; ou\n" +
                ...
                case 11:
                    ...
                    break;
                case 12:
                    System.out.println("Cuidado com ligações de falsas centrais de atendimento: ​Desconfie de ligações ou mensagens recebidas nas quais a pessoa se identifica como sendo funcionário(a) do banco e:\n" +
                            "\n" +
                    ...
                    break;
                case 13:
                    System.out.println("Golpes envolvendo Valores a Receber: ​O único site para saber informações sobre Valores a Receber, inclusive de pessoas falecidas, é https://valoresareceber.bcb.gov.br. Esse serviço é gratuito.\n" +
                            "\n" +
                    ...
                    break;
                case 14:
                    System.out.println("Medidas para evitar golpes envolvendo empréstimo: Não fazer pagamento antecipado para receber empréstimos, principalmente para conta de pessoa física;\n" +
                            "\n" +
                    ...
                    break;
                case 15:
                    System.out.println("Golpes envolvendo o nome do Banco Central: ​O Banco Central:\n" +
                            "\n" +
                    ...
                    break;
                case 16:
                    System.out.println("Golpes envolvendo mensagem Swift ou títulos do Tesouro: ​Os proponentes desse esquema costumam mencionar:\n" +
                            "\n" +
                    ...
                    break;
                case 17:
                    System.out.println("Golpes contra prefeituras: Só juízes e tribunais podem pedir o bloqueio ou o desbloqueio de valores e/ou contas bancárias;\n" +
                            "\n" +
                    ...
                    break;
                case 18:
                    System.out.println("Golpes envolvendo o Meu BC: Na área logada do Meu BC você encontra os relatórios do Registrato, o sistema Valores a Receber e muito mais.\n" +
                            "\n" +
                    ...
                    break;
                default:
                    System.out.println("Obrigado por ler as dicas de segurança financeira, " + nomeUsuario + "!");
                    continuar = "nao";
                    break;
            }

            if (opcao <= 18) {
                System.out.print("\nVocê gostaria de ver a próxima dica? (sim/nao): ");
